...
angular.module('edu-field.tpl').run([
  ...
  function ($templateCache) {
    ...
    $templateCache.put('directives/edu-field-button-tpl.html', '<div class="form-group {{options.col}}"><label for={{id}}>{{options.label}}</label><br><button id={{id}} type=button ng-click=options.onClick() class="btn btn-{{options.state}} btn-{{options.size}}" ng-disabled=options.disabled>{{options.text}}</button></div>');
    $templateCache.put('directives/edu-field-checkbox-tpl.html', '<div class="checkbox {{options.col}}" ng-class="{\'has-error\':  $invalid, \'has-success\': !$invalid && $dirty}"><label><input type=checkbox id={{id}} name=name autofocus ng-false-value="\'N\'" ng-true-value="\'S\'" ng-disabled={{options.disabled}} ng-model=value ng-blur=onBlur() ng-focus=onFocus() ng-change=onChange()> {{options.label || \'Checkbox\'}} {{options.required ? \'*\' : \'\'}}</label><div class="help-block has-error" ng-show=$invalid><small class=error ng-show=$invalidRequired>Campo obligatorio. Introduzca un valor</small></div></div>');
    ...
    $templateCache.put('directives/edu-field-literal-tpl.html', '<div class="form-group {{options.col}}"><label for={{id}}>{{options.label || \'Text\'}} {{options.required ? \'*\' : \'\'}}</label><div id={{id}}>{{options.text}}</div></div>');
